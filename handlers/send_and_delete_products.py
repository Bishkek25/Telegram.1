...
async def delete_all_products (callback_query: types.CallbackQuery):
    ...
    if callback_query.message.photo:
        new_caption = 'товар удалён. Обновить список!'
        ...
        await callback_query.message.edit_media('Товар был удален. Обновите список')

async def register_handlers(dp: Dispatcher):
    dp.register_message_handler(start_send_products, commands='delete_send_products')
